...
return function(){
var n=o.getVideoInfo(),d="",c="";
n[e]&&n[e].hit_bizuin&&(d=n[e].hit_bizuin),n[e]&&n[e].hit_vid&&(c=n[e].hit_vid),
r.report({
step:1,
hit_vid:c,
hit_bizuin:d,
...
dom:e,
vid:w
}),r=["/mp/videoplayer?video_h=",v,"&video_w=",f,"&scene=",window.source,"&random_num=",_,"&article_title=",encodeURIComponent(window.msg_title.htmlDecode()),"&source=4&vid=",w,"&mid=",appmsgid,"&idx=",itemidx||idx,"&__biz=",biz,"&nodetailbar=",window.is_temp_url?1:0,"&uin=",uin,"&key=",key,"&pass_ticket=",pass_ticket,"&version=",version,"&devicetype=",window.devicetype||"","&wxtoken=",window.wxtoken||"","&sessionid=",window.sessionid||""].join(""),
