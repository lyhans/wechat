...
var P=t.card_info.card_id||"",v=t.card_info.card_ext||"";
v=v.htmlDecode();
try{
v=JSON.parse(v),v.outer_str=t.card_info.card_outer_id||"",v=JSON.stringify(v);
}catch(D){
v="{}";
}
return a=extend({
...
var y=g.pt,P=g.pos_type,v=g.product_type;
...
if(urlParser.getQuery("oldAd")&&(g.use_new_protocol=0),u=g.use_new_protocol,n[P]||(n[P]=0),
n[P]++,u)1==u?P===AD_POS.POS_MID?(s=!0,g=t(g),f=g):0===P?(g=i(g),(v===AD_TYPE.ANDROID_APP_PRODUCT_TYPE||v===AD_TYPE.IOS_APP_PRODUCT_TYPE)&&(f=g)):3===P&&(g=_(g),
f=g):2==u&&(P===AD_POS.POS_MID?(s=!0,g=t(g)):0==P&&(g=i(g)),f=g);else if(100===y||115===y){
for(var T=g.exp_info.exp_value||[],w=!1,E=0,A=0;A<T.length;++A){
var h=T[A]||{};
...
var b=g.app_info.down_count||0,x=g.app_info.app_size||0,O=g.app_info.app_name||"",j=g.app_info.category,I=["万","百万","亿"];
if(b>=1e4){
b/=1e4;
for(var C=0;b>=10&&2>C;)b/=100,C++;
b=b.toFixed(1)+I[C]+"次";
}else b=b.toFixed(1)+"次";
x=formSize(x),j=j?j[0]||"其他":"其他",O=formName(O),g.app_info._down_count=b,g.app_info._app_size=x,
...
g.image_url=urlParser.addParam(U,"wxfrom","50",!0)),adDatas.ads[getPosKeyDesc(P,n[P]-1)]={
a_info:g,
adData:f
...
}(g),0===P&&9===g.material_type&&(v===AD_TYPE.MINI_GAME_PRODUCT_TYPE&&g.dest_type===AD_CONFIG.AD_DEST_TYPE.WECHAT_APPLET_DEST_TYPE&&g.game_info&&(g.biz_info.head_img=g.game_info.head_img,
g.biz_info.nick_name=g.game_info.nick_name),v!==AD_TYPE.IOS_APP_PRODUCT_TYPE&&v!==AD_TYPE.ANDROID_APP_PRODUCT_TYPE||!g.app_info||(g.biz_info.head_img=g.app_info.icon_url,
...
var f=M[B],g=!!f&&f.a_info,v=g.product_type;
if(f&&g){
if(g.pos_type===AD_POS.POS_MID&&!adElCountMapByPos[AD_POS.POS_MID]){
var W=getParaList(contentWrp),H=void 0!==g.position_index&&g.position_index>=0&&g.position_index<W.length,L=H?g.position_index:Math.ceil(W.length/2)-1,F=document.createElement("mpcpc");
el_gdt_areas[getPosKeyDesc(AD_POS.POS_MID)]=F,insertAfter(F,W[L]);
}
if(2!==g.use_new_protocol){
if(0==g.pos_type){
if(g.new_appmsg=window.new_appmsg,g.longAppBtnText=v===AD_TYPE.IOS_APP_PRODUCT_TYPE?"查看应用":"下载应用",
g.shortAppBtnText=v===AD_TYPE.IOS_APP_PRODUCT_TYPE?"查看":"下载",js_bottom_ad_area.innerHTML=TMPL.tmpl(a_tpl,g),
111==g.pt||112==g.pt||113==g.pt||114==g.pt){
var K=document.getElementsByClassName("js_download_app_card")[0],G=K.offsetWidth,J=Math.floor(G/2.875);
J>0&&(K.style.height=J+"px");
}
}else if(3==g.pos_type){
var K=document.createElement("div");
K.appendChild(document.createTextNode(g.image_url)),g.image_url=K.innerHTML.replace(/&amp;/g,"&"),
...
var V=js_sponsor_ad_area.clientWidth;
108!=g.pt&&109!=g.pt&&110!=g.pt||2==g.use_new_protocol?116==g.pt||117==g.pt:document.getElementById("js_main_img").style.height=V/1.77+"px",
DomEvent.on(window,"scroll",q),q(0);
}else if(g.pos_type===AD_POS.POS_MID&&checkShowCpc(el_gdt_areas[B],g)){
g=_parseExpCpc(g);
var X=!1;
if(v===AD_TYPE.ANDROID_APP_PRODUCT_TYPE||v===AD_TYPE.IOS_APP_PRODUCT_TYPE)js_cpc_area.innerHTML=TMPL.tmpl(cpc_a_tpl,g),
X=!0;else{
var Q=require("a/tpl/cpc_tpl.html.js"),Z=g.exp_obj.sale_text;
(v===AD_TYPE.ADD_CONTACT_PRODUCT_TYPE||v===AD_TYPE.ANDROID_APP_PRODUCT_TYPE||v===AD_TYPE.IOS_APP_PRODUCT_TYPE||v===AD_TYPE.MINI_GAME_PRODUCT_TYPE)&&(Z=g.avatarTitle),
...
mmversion.isIOS&&g.app_info&&g.app_info.url_scheme&&v===AD_TYPE.IOS_APP_PRODUCT_TYPE&&(document.getElementById("js_promotion_tag")&&(document.getElementById("js_promotion_tag").innerHTML="查看应用"),
...
(v===AD_TYPE.ANDROID_APP_PRODUCT_TYPE||v===AD_TYPE.IOS_APP_PRODUCT_TYPE)&&(X=!0,
g.app_info&&g.app_info.icon_url&&(g.avatar=g.app_info.icon_url,g.avatarTitle=g.app_info.appname)),
v===AD_TYPE.MINI_GAME_PRODUCT_TYPE&&g.game_info&&g.game_info.head_img&&(g.avatar=g.game_info.head_img,
...
btn_text:g.exp_obj.btn_text,
avatar:g.avatar
},X&&(aa.customUpdataFunc=function(e,a){
...
var aa={};
if(g.video_info&&(f.displayWidth=g.video_info.displayWidth,f.displayHeight=g.video_info.displayHeight,
f.thumbUrl=g.video_info.thumbUrl,f.videoUrl=g.video_info.videoUrl,f.rl=g.rl),X&&(aa.customUpdataFunc=function(e,a){
var t=e.querySelector(".js_download_percent"),i=e.querySelector(".js_download_outside"),_=e.querySelector(".js_download_inner");
t&&(t.style.width=a.percent+"%"),i.textContent=a.btn_text,_.textContent=a.btn_text;
...
_a[0]&&(_a=_a[0],g.videoContainer=_a,videoAdMap[g.aid]=new VideoAd(g));
}
...
if(is_temp_url&&adElCountMapByPos[AD_POS.POS_MID]&&!s)for(var na=0;na<adElCountMapByPos[AD_POS.POS_MID];na++){
if(!checkShowCpc(el_gdt_areas[getPosKeyDesc(AD_POS.POS_MID,na)]))return;
el_gdt_areas[getPosKeyDesc(AD_POS.POS_MID,na)].innerHTML=TMPL.tmpl(cpc_a_tpl,{
type:"",
ticket:"",
url:"",
rl:"",
...
function ad_click(e,a,t,i,_,n,p,o,r,d,s,c,l,m,u,f,g,y,P){
if(!has_click[_]){
has_click[_]=!0;
{
var v=document.getElementById("loading_"+_);
g.product_type;
}
...
var A="";
c&&c.weapp_info&&c.weapp_info.original_id&&(A=c.weapp_info.original_id),AdClickReport({
click_pos:1,
report_type:2,
type:e,
exp_id:T,
...
if(has_click[_]=!1,v&&(v.style.display="none"),g.app_info){
...
if(P)if(g.dest_type===AD_CONFIG.AD_DEST_TYPE.OUTER_DEST_TYPE)handleH5(a,_,idx,mid,biz,r,o,s,d,c,g);else if(g.dest_type===AD_CONFIG.AD_DEST_TYPE.WECHAT_APPLET_DEST_TYPE)Wxopen_card.openWxopen(c);else if(g.dest_type===AD_CONFIG.AD_DEST_TYPE.AD_DEST_TYPE)OpenUrlWithExtraWebview(a);else{
...
if(!(!a||3===d||-1!==t.className.indexOf("js_muted_btn")||videoAdMap[a.aid]&&videoAdMap[a.aid].adPlayer&&"play"!==videoAdMap[a.aid].adPlayer.adVideoStatus)){
var i=a.type,c=a.url,l=a.rl,u=a.apurl,f=a.ticket,g=a.group_id,y=a.pt,P=o.use_new_protocol;
if(p){
p.adid=window.adid||p.adid||p.aid;
var v="&tid="+p.traceid+"&uin="+uin+"&key="+key+"&ticket="+(p.ticket||"")+"&__biz="+biz+"&source="+source+"&scene="+scene+"&appuin="+biz+"&aid="+p.adid+"&ad_engine="+s+"&pos_type="+d+"&r="+Math.random();
}
var D,T,w,E;
return D=position.getX(t,"js_material_"+r)+e.offsetX,T=position.getY(t,"js_material_"+r)+e.offsetY,
w=m[0].clientWidth,E=m[0].clientHeight,ad_click(i,c,l,u,n,f,g,_,y,d,s,p,D,T,w,E,o,v,P),
...
var a=p,t=!!e&&e.target,i=a.type,_=o.button_action.jump_url,n=a.rl,c=a.apurl,l=a.tid||o.traceid,m=a.ticket,f=a.group_id,g=a.aid,y=a.pt,P=o.use_new_protocol;
...
w=u[0].clientWidth,E=u[0].clientHeight,ad_click(i,_,n,c,l,m,f,g,y,d,s,p,D,T,w,E,o,v,P),
log("[Ad] ad_click: type="+i+", url="+_+", rl="+n+", apurl="+c+", traceid="+l+", ticket="+m+", group_id="+f+", aid="+g+", pt="+y+", pos_type="+d+", ad_engine="+s),
!1;
});
}else for(var v=0,D=t.length;D>v;++v)!function(e,a){
var i=t[e],p=i.dataset;
if(p&&3!=o.pos_type){
var r=p.type,c=p.url,l=p.rl,m=p.apurl,u=p.ticket,f=p.group_id,g=p.pt,y=o.use_new_protocol,P=!0;
n=p.tid,_=p.aid,(y&&(o.product_type===AD_TYPE.ANDROID_APP_PRODUCT_TYPE||o.product_type===AD_TYPE.IOS_APP_PRODUCT_TYPE)||115===g)&&(P=!1),
o.pos_type===AD_POS.POS_MID&&(P=!1),DomEvent.on(i,"click",function(e){
...
var P,v,D,T;
return P=position.getX(t,"js_ad_link")+e.offsetX,v=position.getY(t,"js_ad_link")+e.offsetY,
...
ad_click(r,c,l,m,n,u,f,_,g,d,s,a,P,v,D,T,o,p,y),log("[Ad] ad_click: type="+r+", url="+c+", rl="+l+", apurl="+m+", traceid="+n+", ticket="+u+", group_id="+f+", aid="+_+", pt="+g+", pos_type="+d+", ad_engine="+s),
!1;
}
},P),DomEvent.on(i,"touchstart",function(){
...
var f=require("a/app_card.js"),g=15,y=p.pkgname&&p.pkgname.replace(/\./g,"_"),b=document.getElementById("js_ad_btn_"+d);
new f({
btn:b,
adData:p,
report_param:h,
...
9==o.material_type&&(o.report_param=h,videoAdMap[o.aid]=new VideoAd(o));
}else{
...
if("102"==p.pt){
var x=require("a/android.js"),g=15,y=p.pkgname&&p.pkgname.replace(/\./g,"_");
return void new x({
...
"118"==o.pt&&(p.report_param=h),"125"==o.pt&&(o.report_param=h,videoAdMap[o.aid]=new VideoAd(o));
}
}
}
}(e);
...
report_param:l,
url:e
}):s.dest_type!==AD_CONFIG.AD_DEST_TYPE.OUTER_DEST_TYPE||isItunesLink(e)?s.dest_type===AD_CONFIG.AD_DEST_TYPE.WECHAT_APPLET_DEST_TYPE?void Wxopen_card.openWxopen(d):s.dest_type===AD_CONFIG.AD_DEST_TYPE.WECHAT_SHOP_DEST_TYPE?void OpenUrlWithExtraWebview(urlParser.join(e,{
outer_id:d.outer_id
...
if(isItunesLink(s.app_info.appinfo_url)){
...
s.product_type===AD_TYPE.IOS_APP_PRODUCT_TYPE&&extend(g,{
...
var v="",D="";
d&&(v=d.pkgname&&d.pkgname.replace(/\./g,"_"),D=d.channel_id||""),y={
source:4,
tid:a,
traceid:a,
mid:i,
