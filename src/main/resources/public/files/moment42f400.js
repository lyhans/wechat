...
var n=e.container;
if(!n)return!1;
for(var i=n.getElementsByTagName("a")||[],o=0,a=i.length;a>o;++o)!function(n){
var o=i[n],a=o.getAttribute("href");
if(!a)return!1;
var c=0,s=o.innerHTML;
/^[^<>]+$/.test(s)?c=1:/^<img[^>]*>$/.test(s)&&(c=2),!!e.changeHref&&(a=e.changeHref(a,c)),
t.on(o,"click",function(){
return window.__second_open__?r(a,{
sample:1,
reject:function(){
location.href=a;
}
...
var t=e("biz_common/dom/event.js"),r=e("appmsg/open_url_with_webview.js");
return n;
...
});define("appmsg/async.js",["biz_common/utils/string/html.js","appmsg/comment_utils.js","pages/create_txv.js","pages/video_ctrl.js","biz_common/utils/url/parse.js","biz_common/dom/class.js","appmsg/img_copyright_tpl.html.js","appmsg/appmsgext.js","appmsg/share_tpl.html.js","biz_common/dom/event.js","biz_wap/utils/ajax.js","biz_wap/jsapi/core.js","biz_common/tmpl.js","biz_wap/utils/storage.js","appmsg/log.js","rt/appmsg/getappmsgext.rt.js","a/a.js","biz_wap/utils/mmversion.js","pages/version4video.js","appmsg/like.js","appmsg/reward_entry.js","appmsg/iframe.js","appmsg/more_read.js"],function(e,t,r,i){
"use strict";
function n(){
...
e("appmsg/log.js")),B=(e("rt/appmsg/getappmsgext.rt.js"),e("a/a.js")),z=e("biz_wap/utils/mmversion.js"),A=[];
n(),s();
...
var t;
if(e.origin?t=e.origin:e.originalEvent&&(t=e.originalEvent.origin),/^http(s)?\:\/\/finance\.qq\.com$/.test(t)&&/^http(s)?\:\/\/gu\.qq\.com$/.test(t)&&e.source){
...
var n=document.getElementById("js_content"),o=document.getElementById("img-content"),a=document.getElementById("js_article"),m=document.getElementsByClassName("rich_media_area_extra")[0];
m.style.display="none",e("pageHeight"),window.addEventListener("message",t,!1);
...
});define("a/mpAdAsync.js",["appmsg/log.js","biz_wap/utils/ajax.js","rt/appmsg/getappmsgext.rt.js","a/a.js"],function(e){
"use strict";
function i(e){
for(var i=window.location.href,t=i.indexOf("?"),a=i.substr(t+1),d=a.split("&"),o=0;o<d.length;o++){
var n=d[o].split("=");
...
function t(e,t,d){
var c=[],p=m.checkNeedAds(),g=p.is_need_ad,w=p.both_ad,l=i("mock"),v=i("rtx"),f=location.protocol+"//mp.weixin.qq.com/mockserver/mockservercgi-bin/offerTestCase/mmbizwap/mp/getappmsgad",_="/mp/getappmsgad";
t=t||{},e||(e=[]);
for(var A=0;A<e.length;A++)0==e[A].indexOf("wxv")&&c.push(e[A]);
(l&&"-1"!=l||v)&&(console.info("[广告走mock系统] mockId",l,"rtx",v),_=f),console.info("[广告发送请求] 是否拉取广告",g),
s({
url:_+"?f=json&mockid="+l+"&rtx="+v,
data:{
r:Math.random(),
__biz:biz,
...
async:!0,
success:function(e){
n("[Appmsg] success get async ad data"),console.info("[广告响应请求]",e);
var i;
if(window.can_see_complaint=e.can_see_complaint,m.afterGetAdData(p,e),m.setBackgroundClass(),
0==g?(i=p._adInfo,i||(i={
advertisement_num:0
})):i=e,i.advertisement_info&&0!=i.advertisement_info.length)try{
if(n("[Appmsg] success get async ad data, async data is: "+JSON.stringify(i)),window.originalVideoAdFramesAdData={},
i.advertisement_info)for(var t=0;t<i.advertisement_info.length;t++)i.advertisement_info[t].cdg_appid=i.appid,
i.advertisement_info[t].vid&&(window.originalVideoAdFramesAdData[i.advertisement_info[t].vid]=o(i.advertisement_info[t]));
if(window.originalVideoAdFramesUnsetList&&0!=window.originalVideoAdFramesUnsetList.length)for(var s,r=document.getElementsByTagName("iframe"),t=0;t<window.originalVideoAdFramesUnsetList.length;t++)for(var w=0;w<r.length;w++)if(r[w].dataset&&r[w].dataset.mpvid==window.originalVideoAdFramesUnsetList[t]){
window.originalVideoAdFramesAdData[r[w].dataset.mpvid]||(window.originalVideoAdFramesAdData[r[w].dataset.mpvid]={}),
s=window.originalVideoAdFramesAdData[r[w].dataset.mpvid],r[w].contentWindow.postMessage({
...
c[0]&&window.postMessage({
action:"receiveOriginalVideoData",
vid:c[0],
adData:window.originalVideoAdFramesAdData[c[0]]
},"*");
}catch(l){}else n("[Appmsg] success get async ad data, async data is empty"),a(c);
d&&d();
},
error:function(){
n("[Appmsg] error get async ad data, biz="+biz+", mid="+mid),a(c);
}
});
}
function a(e){
...
var a=e[t],n=typeof a;
a="string"==n?a.htmlDecode():a,"object"==n&&(a="[object Array]"==Object.prototype.toString.call(a)?d(a):o(a)),
i.push(a);
}
return i;
}
...
var n=e("appmsg/log.js"),s=e("biz_wap/utils/ajax.js"),r=e("rt/appmsg/getappmsgext.rt.js"),m=e("a/a.js");
return{
getAdData:t
};
